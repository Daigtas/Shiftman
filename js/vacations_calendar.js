$(document).ready(function () {
    ...
    function initializeVacationsCalendar() {
    ...
    function saveData() {
        const data = JSON.parse(localStorage.getItem('vacationsData')) || {};
        ...
        localStorage.setItem('vacationsData', JSON.stringify(data));
