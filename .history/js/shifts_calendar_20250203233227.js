$(document).ready(function () {
    ...
    function saveData() {
        ...
        showSuccessMessage(translations.dataSaved);
    ...
    $('#easyModeButton').off('click').on('click', function () {
        ...
        $(this)
            ...
            .html(easyModeActive 
                ? '<i class="fas fa-check-circle"></i> ' + translations.easyModeActive
                : '<i class="fas fa-edit"></i> ' + translations.enableEasyMode);
        ...
        if (easyModeActive && !$('#saveButton').length) {
            $('<button/>', {
                ...
                html: '<i class="fas fa-save"></i> ' + translations.saveChanges
